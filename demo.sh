...
python3 main.py --data_test DIV2K --ext img --n_val 10 --scale 3 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train ../experiment/metardn/model/EDSR_1000.pt --test_only
python3 main.py --data_test DIV2K --ext img --n_val 10 --scale 2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train ../experiment/model/EDSR_x2.pt --test_only --self_ensemble
...
python3 main.py --template RCAN --save RCAN_BIX2_G10R20P48 --scale 2 --reset --save_results --patch_size 96
